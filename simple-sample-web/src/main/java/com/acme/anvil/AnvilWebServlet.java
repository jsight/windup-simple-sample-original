...
public class AnvilWebServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			local  = (ItemLookupLocal)ic.lookup("java:global/simple-sample-weblogic-app-1.0.0-SNAPSHOT/simple-sample-services/ItemLookupBean!com.acme.anvil.service.ItemLookupLocal");
